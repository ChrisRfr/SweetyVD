    ...
    CompilerElseIf #PB_Compiler_OS = #PB_OS_Linux
      CompilerIf #PB_Compiler_Processor = #PB_Processor_x86
        ...
        Procedure CreateGadgets(IdModel.i)
          ...
          With ModelGadget(IdModel)
            ...
            If \Caption = "#Nooo"
              TmpCaption=""
            Else
              If IdModel = 14 Or IdModel = 31  ;Specific HyperLinkGadget, WebGadget
        ...
        Procedure CodeGenerate()
          ...
          With Buffer(0)
            Name = \Name
            Width = GetGadgetText(#SetDrawWidth)
            Height = GetGadgetText(#SetDrawHeight)
            Caption = \Caption
          ...
          For I=1 To ArraySize(Buffer())
            With Buffer(I)
              ...
              If \ModelType <> 1
                ...
                If \IdModel = 23 : Code +#INDENT+#INDENT+ "If InitScintilla()" +#CRLF$+#INDENT : EndIf   ;Specific ScintillaGadget
                ...
                Select \IdModel
                  ...
                  Case 9  : Code +#INDENT+#INDENT+ "AddGadgetItem("+ Name + ", -1, " + #DQUOTE$ + Mid(Name,2) + #DQUOTE$ + ")" +#CRLF$
                  Case 16 : Code +#INDENT+#INDENT+ "SetGadgetState("+ Name + ", MakeIPAddress(127, 0, 0, 1))" +#CRLF$
                  Case 23 : Code +#INDENT+#INDENT+ "EndIf" +#CRLF$
        ...
        Procedure LoadGadgetProperties(IdGadget.i)
          ...
          With Gadgets(GadgetsElement)
            ...
            EndIf
            If \IdModel = 24 : SetGadgetText(#MiniText, "InnerW") : SetGadgetText(#MaxiText, "InnerH") : EndIf
            If \IdModel = 28 : DisableGadget(#ToolTipString,#True) : EndIf
        ...
        Procedure OpenMainWindow(SelectDrawArea.l = 0, X = 0, Y = 0, Width = 800, Height = 540)
          ...
          StringGadget(#CaptionText, 0, 2, 60, 22, "Caption", #PB_String_ReadOnly)
          StringGadget(#CaptionString, 60, 2, 146, 22, "")
          StringGadget(#ToolTipText, 0, 24, 60, 22, "ToolTip", #PB_String_ReadOnly)
          StringGadget(#ToolTipString, 60, 24, 146, 22, "")
          ...
          StringGadget(#ImageText, 0, 46, 60, 22, "Image", #PB_String_ReadOnly)
          StringGadget(#ImageString, 60, 46, 119, 22, "C:\xxxx\PB.jpg", #PB_String_ReadOnly)
        ...
        DataSection   ;- Data Section (Model)
          ...
          Data.s "OpenWindow","0","","520","400","Window","","","","","#Nooo","","Window_SystemMenu(x)|Window_MinimizeGadget(x)|Window_MaximizeGadget(x)|Window_SizeGadget(x)|Window_Invisible|Window_TitleBar|Window_Tool|Window_BorderLess|Window_ScreenCentered(x)|Window_WindowCentered|Window_Maximize|Window_Minimize|Window_NoGadgets"
          ...
          Data.s "ContainerGadget","7","11","200","50","Container","#Nooo","","","","","","Container_BorderLess|Container_Flat|Container_Raised|Container_Single|Container_Double"
          Data.s "DateGadget","8","21","120","20","Date","","#Date","","","#Nooo","#Nooo","Date_UpDown|Date_CheckBox"
          Data.s "EditorGadget","9","22","140","40","Editor","#Nooo","","","","","",""
          Data.s "ExplorerComboGadget","10","25","120","20","ExplorerCombo","","","","","#Nooo","#Nooo","Explorer_DrivesOnly|Explorer_Editable|Explorer_NoMyDocuments"
          Data.s "ExplorerListGadget","11","23","160","80","ExplorerList","","","","","","","Explorer_NoMyDocuments|Explorer_BorderLess|Explorer_AlwaysShowSelection|Explorer_MultiSelect|Explorer_GridLines|Explorer_HeaderDragDrop|Explorer_FullRowSelect|Explorer_NoFiles|Explorer_NoFolders|Explorer_NoParentFolder|Explorer_NoDirect"
          Data.s "ExplorerTreeGadget","12","24","160","80","ExplorerTree","","","","","","","Explorer_BorderLess|Explorer_AlwaysShowSelection|Explorer_NoLines|Explorer_NoButtons|Explorer_NoFiles|Explorer_NoDriveRequester|Explorer_NoMyDocuments|Explorer_AutoSort"
          Data.s "FrameGadget","13","7","200","50","Frame3D","","","","","#Nooo","#Nooo","Frame_Single|Frame_Double|Frame_Flat"
          Data.s "HyperLinkGadget","14","10","150","20","Hyperlink","","#Hard:RGB(0,0,128)","","","","","HyperLink_Underline"
          Data.s "ImageGadget","15","9","140","40","Image","#Nooo","#Imag:0","","","#Nooo","#Nooo","Image_Border"
          Data.s "IPAddressGadget","16","13","100","20","IPAddress","#Nooo","","","","#Nooo","#Nooo",""
          Data.s "ListIconGadget","17","12","140","40","ListIcon","#Nooo","#Titl","#Widh:140","","","","ListIcon_CheckBoxes|ListIcon_ThreeState|ListIcon_MultiSelect|ListIcon_GridLines|ListIcon_FullRowSelect|ListIcon_HeaderDragDrop|ListIcon_AlwaysShowSelection"
          Data.s "ListViewGadget","18","6","140","40","ListView","#Nooo","","","","","","ListView_MultiSelect|ListView_ClickSelect"
          Data.s "OpenGLGadget","19","34","100","20","OpenGL","#Nooo","","","","#Nooo","#Nooo","OpenGL_Keyboard"
          Data.s "OptionGadget","20","5","100","20","Option","","","","","#Nooo","#Nooo",""
          Data.s "PanelGadget","21","28","200","50","Panel","#Nooo","","","","#Nooo","#Nooo",""
          Data.s "ProgressBarGadget","22","14","140","14","ProgressBar","#Nooo","#Mini:0","#Maxi:0","","","","ProgressBar_Smooth|ProgressBar_Vertical"
          Data.s "ScintillaGadget","23","31","140","40","Scintilla","#Nooo","#Hard:0","","","#Nooo","#Nooo",""
          Data.s "ScrollAreaGadget","24","16","200","50","ScrollArea","#Nooo","#InrW:0","#InrH:0","#Step:10","","","ScrollArea_Flat|ScrollArea_Raised|ScrollArea_Single|ScrollArea_BorderLess|ScrollArea_Center"
          Data.s "ScrollBarGadget","25","15","140","16","Scrollbar","#Nooo","#Mini:0","#Maxi:0","#Long:0","#Nooo","#Nooo","ScrollBar_Vertical"
          Data.s "SpinGadget","26","26","100","20","Spin","#Nooo","#Mini:0","#Maxi:0","","","","Spin_ReadOnly|Spin_Numeric(x)"
          Data.s "StringGadget","27","2","100","20","String","","","","","","","String_Numeric|String_Password|String_ReadOnly|String_LowerCase|String_UpperCase|String_BorderLess"
          Data.s "TextGadget","28","3","100","20","Text","","","","","","","Text_Center|Text_Right|Text_Border"
          Data.s "TrackBarGadget","29","17","100","20","TrackBar","#Nooo","#Mini:0","#Maxi:0","","#Nooo","#Nooo","TrackBar_Ticks|TrackBar_Vertical"
          Data.s "TreeGadget","30","27","100","20","Tree","#Nooo","","","","","","Tree_AlwaysShowSelection|Tree_NoLines|Tree_NoButtons|Tree_CheckBoxes|Tree_ThreeState"
          Data.s "WebGadget","31","18","260","125","WebView","","","","","#Nooo","#Nooo",""
        EndDataSection
      CompilerEndIf
